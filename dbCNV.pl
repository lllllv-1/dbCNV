...
Usage:
    ...
    perl cal_feature_v1.pl  [Options]
...
Example
   perl cal_feature_v1.pl -i ./cnv_file.txt -n 2 
USAGE
...
if(($n==5)and($gain_file eq "Y")){
   ...
   `/share/udata/chendayang/01.bin/ll/envs/R3.5/bin/Rscript $dir/predication_5_gain.R`;
   &trans("$dir/gain_5_predication.txt","$dir/gain_5_test.txt");
  `rm $dir/gain_5_predication.txt`;
  `rm $dir/gain_5_test.txt`;
...
if(($n==5)and($loss_file eq "Y")){
  ...
  `/share/udata/chendayang/01.bin/ll/envs/R3.5/bin/Rscript predication_5_loss.R`;
  &trans("$dir/loss_5_predication.txt","$dir/loss_5_test.txt");
  `rm $dir/loss_5_predication.txt`;
  `rm $dir/loss_5_test.txt`;
...
if(($n==2)and($gain_file eq "Y")){
   ...
   `/share/udata/chendayang/01.bin/ll/envs/R3.5/bin/Rscript predication_2_gain.R`;
   &trans("$dir/gain_2_predication.txt","$dir/gain_2_test.txt");
   `rm $dir/gain_2_predication.txt`;
   `rm $dir/gain_2_test.txt`;
...
if(($n==2)and($loss_file eq "Y")){
   ...
   `/share/udata/chendayang/01.bin/ll/envs/R3.5/bin/Rscript predication_2_loss.R`;
   &trans("$dir/loss_2_predication.txt","$dir/loss_2_test.txt"); 
  `rm $dir/loss_2_predication.txt`;
  `rm $dir/loss_2_test.txt`;
